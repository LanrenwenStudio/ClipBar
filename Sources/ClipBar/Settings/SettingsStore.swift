...
final class SettingsStore {
    ...
    func load() -> AppSettings {
        ...
        if let key = secretStore.loadManagementKey() {
            ...
            settings.managementKey = key
            secretStore.saveManagementKey(key)
    ...
    private func apply(_ settings: AppSettings) {
        var merged = settings
        merged.managementKey = secretStore.loadManagementKey() ?? settings.managementKey
        saveLocal(merged)
    }

    private func saveLocal(_ settings: AppSettings) {
