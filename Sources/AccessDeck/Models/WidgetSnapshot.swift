...
struct ProviderWidgetData: Codable, Identifiable, Sendable {
    ...
    /// The compact hour bucket used by the macOS status bar (5h, 4h, …, 1h).
    var nearestFiveHourDisplayText: String? {
        StatusBarSummary.shortResetText(from: nearestFiveHourResetText)
    }
...
struct AccessDeckWidgetSnapshot: Codable, Sendable {
    ...
    static var preview: AccessDeckWidgetSnapshot {
        ...
        return AccessDeckWidgetSnapshot(
            lastUpdated: Date(),
            isConfigured: true,
    ...
    static var empty: AccessDeckWidgetSnapshot {
        AccessDeckWidgetSnapshot(
            lastUpdated: Date(),
            isConfigured: false,
